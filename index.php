...
<body>
    <div class="page">
        <nav>
            <a class="active" href="index.php">Kezdőoldal</a>
            <a href="public.php">Nyilvános oldal</a>
            <a href="protected.php">Védett oldal</a>
        </nav>

        <header>
            <h1>Kezdőoldal</h1>
            <h2>Ezen oldal tartalma nyilvános.</h2>
        </header>

        <div class="content">
            <h3>Ez a tartalom nyilvánosan megtekinthető.</h3>
